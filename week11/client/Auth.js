...
export default class Auth {
    ...
    async login(callBack) {
        //replace the ids below with wahtever you used in your form
        const password = document.getElementById('password');
        const username = document.getElementById('username');
        const postData = {
            email:username.ariaValueMax,
    ...
    // uses the email of the currently logged in user to pull up the full user details for that user from the details for that user from the database
